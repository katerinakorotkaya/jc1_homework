...
class AlfaBank extends Card {
    private String bankName;
    private int cardId;
    private int password;
    private double balance;

    public AlfaBank(String bankName, int cardId, int password, double balance) {
    ...
    protected void repBalance(int balance) {
        ...
        this.balance += balance;
        System.out.println("Your balance on AlfaBank card is USD " + this.balance);
